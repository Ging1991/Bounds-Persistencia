...
namespace Bounds.Persistencia {
	...
	public class ControlUIBounds : MonoBehaviour {
		...
		public void Personalizar(string direccionTexto, string direccionColor) {
			/*controlUI.Inicializar(new ProveedorColores(direccionColor, TipoLector.RECURSOS));
			Traductor.Instancia.Inicializar(new ProveedorTexto(direccionTexto, TipoLector.RECURSOS));
